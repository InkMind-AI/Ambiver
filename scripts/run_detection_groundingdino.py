#!/usr/bin/env python3
"""
子进程检测脚本：在 groundingdino 环境中运行 GroundingDINO 检测。
供 SubprocessDetector 调用，解决 qwen3vl 与 GroundingDINO 环境不兼容问题。

用法: python run_detection_groundingdino.py --images_dir DIR --target_text TEXT --output_pickle PKL --gpu_id ID
"""
import argparse
import os
import pickle
...
# GroundingDINO paths (override with GROUNDING_DINO_ROOT)
